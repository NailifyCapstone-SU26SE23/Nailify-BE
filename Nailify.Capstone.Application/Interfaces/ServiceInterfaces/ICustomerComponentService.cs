...
namespace Nailify.Capstone.Application.Interfaces.ServiceInterfaces
{
    public interface ICustomerComponentService
    {
        ...
        Task<ApiResult<CustomerComponentDto>> CreateCustomerComponentAsync(CustomerComponentCreateRequest request, string? imageUrl = null, Guid? userId = null);
        Task<ApiResult<CustomerComponentDto>> UpdateCustomerComponentAsync(int id, CustomerComponentUpdateRequest request, string? imageUrl = null);
